...
function Host() {
  const [detailsArrow, setDetailsArrow] = useState(
    "https://www.zoomcar.com/zap/subscribe/build/145dbdacf67ffb58dcc19159ad49e336.png"
  );
  ...
  const handleArrow = () => {
    if (
      ...
      setDetailsArrow(
        "https://www.zoomcar.com/zap/subscribe/build/3c157e2ab203052562fc508f65ac5104.png"
      );
    } else {
      setDetailsArrow(
        "https://www.zoomcar.com/zap/subscribe/build/145dbdacf67ffb58dcc19159ad49e336.png"
  ...
  return (
    <>
      <div id="page" onClick={handleVideo}>
        ...
        <div id="earning-container">
          <div id="box1">
            ...
            <div class="box2">
              ...
              <div>
                <div>
                  <p class="font">Earn Joining Bonus of Upto</p>
                </div>
        ...
        <div id="steps">
          ...
          <div>
            <div>
              ...
              <p>
                Share your car details with us throuth this <a href="">form</a>{" "}
                and shedule a car inspection from our experts
              </p>
            </div>
            <div>
              <div>
              ...
              <p>
                Signup on the app and provide your PAN, Bank and Address details
            ...
            <div>
              ...
              <p>
                Select the sharing dates for your car. Our experts will visit
                you to install the safty devices and you are ready to earn
              </p>
            </div>
          </div>
        </div>
        <div id="whyShare">
          <div id="why">
            <p>Why share your car with us?</p>
          </div>
          <div>
            ...
            <p>
              We provide damage cover and handle repairs in case of damage
              during a booking
            </p>
          </div>
          <div>
            ...
            <p>
              Our hosts earn upto Rs.50000 per month along with added bounces
              for sharing their cars
            </p>
          </div>
          <div>
            ...
            <p>
              Using our mobile app, you can share your convenience and shedule
            </p>
          </div>
          <div>
            <img src={car} alt="" />
            ...
            <p>
              We install safety and keyless entry devices to make sharing your
              car a safe, secured and smoooth process
            </p>
          </div>
        </div>
        <div>{video}</div>
            ...
            <div>
              ...
              <div
                ...
                onClick={() => {
                  ...
                  document.getElementById("page").style.backgroundColor =
                    "#66666673";
                  document.getElementById("youtub-video").style.position =
                    "fixed";
                }}
              >
                <img
                  src="https://doav52ie4cv60.cloudfront.net/images/play.png"
                  class="host-testimonials-container-blocks-block-play-icon"
                />
              </div>
              ...
              <div class="subBox">
                ...
                <img
                  src="https://doav52ie4cv60.cloudfront.net/images/quotes.svg"
                  class="host-testimonials-container-blocks-block-description-image"
                />
                <p class="font">Passive income for me</p>
                <p>
                  Around 10-15 % of the amount I receive goes to EMI, rest of
                  the amount is a passive income for me
                </p>
              </div>
            </div>
            <div>
              ...
              <div class="subBox">
                ...
                <p>
                  I am in love with this idea and enjoying my time with Zoomcar
                  host. My car is paying for itself and that's great benefit
                </p>
              </div>
            </div>
            <div>
              ...
              <div class="subBox">
                ...
                <p>
                  Average I earn ₹20-26k per month, that's a great return on
                  investment on my car{" "}
                </p>
              </div>
            </div>
          </div>
        ...
        <div id="gift">
          <img
            src="https://doav52ie4cv60.cloudfront.net/in/host/share-your-car/images/ZH_referral_banner_app_02.jpg"
            alt=""
          />
        </div>
        <div id="questions">
          ...
          <div>
            <div>
              <div class="question">
                ...
                <div class="host-questions-accordion-block-header-arrow-container">
                  <img
                    src="https://www.zoomcar.com/zap/subscribe/build/145dbdacf67ffb58dcc19159ad49e336.png"
                    class="host-questions-accordion-block-header-arrow-container-image"
                  />
                </div>
              </div>
              <div></div>
            ...
            <div>
              <div class="question">
                ...
                <p>
                  What happens if my car gets challans or traffic fines while my
                  car is being shared?
                </p>
                <div class="host-questions-accordion-block-header-arrow-container">
                  <img
